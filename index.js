...
class ERCManager {
    ...
    async transfer() {
        ...
        // Determine the nonce
        var count = await web3.eth.getTransactionCount(this.myAddress);
        ...
        var contract = new web3.eth.Contract(abiArray, this.contractAddress, {
            from: this.myAddress
        });
        ...
        var rawTransaction = {
            ...
            "gasPrice": web3.utils.toHex(this.gasPriceGwei * 1e9),
